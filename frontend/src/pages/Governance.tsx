            ...
            <form onSubmit={handleRequestRole}>
              ...
              <div className="w-1/5 mx-auto">
                ...
                <div className="mb-12">
                  ...
                  <textarea
                    ...
                    onFocus={(e) => e.target.style.borderColor = 'var(--color-edh-black)'}
                    onBlur={(e) => e.target.style.borderColor = 'var(--color-edh-gray-light)'}
                    required
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="py-4 px-12 font-bold tracking-widest uppercase text-xs hover:bg-white hover:text-black border-2 transition-all disabled:opacity-50"
                  style={{
              ...
              <div className="mt-8 border-l-2 pl-4 py-2" style={{ borderColor: 'var(--color-edh-black)' }}>
            ...
            <form onSubmit={handleExecuteProposal}>
              ...
              <div className="flex justify-center">
                <button
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'var(--color-edh-gray)'}
                  onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'var(--color-edh-black)'}
                >
