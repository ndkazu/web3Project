          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-12 mt-16">
              ...
              <div>
                ...
                <p className="font-light leading-relaxed" style={{ color: 'var(--color-edh-gray)' }}>
              ...
              <div>
                ...
                <p className="font-light leading-relaxed mb-4" style={{ color: 'var(--color-edh-gray)' }}>
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={i} className="flex items-start">
                      ...
                      <span className="text-sm font-light" style={{ color: 'var(--color-edh-gray)' }}>
                        {item}
                      </span>
                    </li>
                  ))}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={i} className="border-l-2 pl-4" style={{ borderColor: 'var(--color-edh-black)' }}>
                      <h3
                        className="text-sm font-medium tracking-wider uppercase mb-2"
                        style={{ color: 'var(--color-edh-black)', letterSpacing: '0.1em' }}
                      >
                        {feature.title}
                      </h3>
                      <p className="text-xs font-light" style={{ color: 'var(--color-edh-gray)' }}>
                        {feature.desc}
                      </p>
                    </div>
                  ))}
              ...
              {/* Network Info */}
              <div className="border-t pt-8" style={{ borderColor: 'var(--color-edh-gray-light)' }}>
                <h3
                  className="text-xs tracking-widest uppercase mb-4 text-center"
                  style={{ color: 'var(--color-edh-black)', letterSpacing: '0.2em' }}
                >
                  Network Information
                </h3>
                <p className="text-xs font-light text-center" style={{ color: 'var(--color-edh-gray)' }}>
                  Ensure your local substrate node is running on ws://127.0.0.1:9944
                </p>
                <p className="text-xs font-light text-center mt-2" style={{ color: 'var(--color-edh-gray)' }}>
