...
export function Membership() {
  ...
  return (
    <div className="min-h-screen px-8 py-16" style={{ backgroundColor: 'var(--color-luxury-cream)' }}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <div className="w-32 h-px mx-auto" style={{ backgroundColor: 'var(--color-luxury-gold)' }} />
        </div>
        ...
        <div className="bg-white luxury-shadow p-12 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          {subscriptionStatus.hasSubscription && (
            <div className="mb-12 p-8 border-l-4" style={{ borderColor: 'var(--color-luxury-gold)', backgroundColor: 'var(--color-luxury-cream)' }}>
              <p className="text-base tracking-widest uppercase mb-3" style={{ color: 'var(--color-luxury-gray)', letterSpacing: '0.15em' }}>
                Current Membership
              </p>
              <p className="text-3xl font-light mb-2" style={{ color: 'var(--color-luxury-black)' }}>
                {subscriptionStatus.subscriptionType}
              </p>
              {subscriptionStatus.name && (
                <p className="text-xl font-light" style={{ color: 'var(--color-luxury-gray)' }}>
                ...
                <>
                  <div className="mb-6">
                    <label className="flex items-center cursor-pointer group">
                      ...
                      />
                      <span className="text-sm font-light tracking-wide group-hover:opacity-75 transition-opacity" style={{ color: 'var(--color-luxury-black)' }}>
          ...
          {/* Tier Benefits */}
          <div className="mt-20 pt-16 border-t" style={{ borderColor: 'var(--color-luxury-light-gray)' }}>
            <h3 className="text-lg tracking-widest uppercase mb-12 text-center" style={{ color: 'var(--color-luxury-gold)', letterSpacing: '0.2em' }}>
              Tier Benefits
            </h3>
            <div className="max-w-3xl mx-auto space-y-10">
              {[
                ...
                <div key={tier.name} className="text-center">
                  <p className="font-medium text-2xl mb-3" style={{ color: 'var(--color-luxury-black)' }}>
                    <span style={{ color: 'var(--color-luxury-gold)' }}>— </span>
                    {tier.name} {tier.amount !== '0' && `(${tier.amount} tokens)`}
                  </p>
                  <p className="text-lg font-light leading-relaxed" style={{ color: 'var(--color-luxury-gray)' }}>
                    {tier.desc}
                  </p>
                </div>
              ))}
